...
require_once 'admin/models/get_articles.php';
...
<head>
    ...
    <link rel="stylesheet" href="public/css/stylees.css">
...
<!-------------------------- HEADER----------------------------->
    <header data-color="white">
        <?php
            //inclure le header
            include 'public/pages/header.php';
        ?>
    </header>
...
<!-------------------------- FOOTER----------------------------->
    <footer>
        <?php
            include 'public/pages/footer.php';
        ?>
    </footer>
